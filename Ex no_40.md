...
void swap(char *x, char *y) { char temp[100]; strcpy(temp, x); strcpy(x, y); strcpy(y, temp); }

int compare(const void *a, const void b) { return strcmp((const char **)a, *(const char **)b); }

int next_permutation(char *arr[], int n) { int i = n - 2; while(i >= 0 && strcmp(arr[i], arr[i + 1]) >= 0) i--; if(i < 0) return 0;
...
## Output:
<img width="464" height="230" alt="image" src="https://github.com/user-attachments/assets/25118dcf-6f6c-4059-9266-d03ad756a422" />
